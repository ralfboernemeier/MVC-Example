...
public class Crypt {
	...
	/**
	 *  Class to encrypt/decrypt a given Password(String)
	 *  Reference: 
	...
	private static String secretKey = "This_is_a_very_secure_key!!!";
	private static String salt = "ralf.boernemeier@ralfb-web.de";
